...
public class CamposObrigatoriosNaoPreenchidosTestTA3 {

    @Rule
    public ActivityTestRule<LoginActivity> mActivityTestRule = new ActivityTestRule<>(LoginActivity.class);

    @Test
    public void camposObrigatoriosNaoPreenchidosTestTA3() {
        ...
        ViewInteraction editText = onView(
                allOf(withId(R.id.edtNome), withText("Eduardo"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText.check(matches(withText("Campos obrigatorios nao preenchidos")));
        ...
        ViewInteraction editText2 = onView(
                allOf(withId(R.id.edtNome), withText("Eduardo"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        editText2.check(matches(withText("Campos obrigatorios nao preenchidos")));
