...
public class AcceptanceTestLoginActivity {
    ...
    @Test
    /**
     * Esse método precisa vir antes do attempToLoginSuccessfully, pq ele cria uma conta
     */
    public void attempToLoginCreatingAccount() throws Exception {
        doLogout();
    ...
    @Test
    /**
     * Usuário já foi cadastrado, então só tento fazer login
     */
