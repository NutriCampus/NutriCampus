...
public class LoginActivity extends AppCompatActivity {
    ...
    private void criarUsuarioDefault() {
        ...
        if (repo.buscarUsuario(admin, admin) == null) {
            ...
            DadosComplAnimal dadosComplAnimal1 = new DadosComplAnimal(Calendar.getInstance(), 1, 1000, 100, 10, 1, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal2 = new DadosComplAnimal(Calendar.getInstance(), 2, 2000, 200, 20, 2, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal3 = new DadosComplAnimal(Calendar.getInstance(), 3, 3000, 300, 30, 3, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal4 = new DadosComplAnimal(Calendar.getInstance(), 4, 4000, 400, 40, 4, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal5 = new DadosComplAnimal(Calendar.getInstance(), 5, 5000, 500, 50, 5, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal6 = new DadosComplAnimal(Calendar.getInstance(), 6, 6000, 600, 60, 6, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal7 = new DadosComplAnimal(Calendar.getInstance(), 7, 7000, 700, 70, 7, 4, true, true, false, false);
            DadosComplAnimal dadosComplAnimal8 = new DadosComplAnimal(Calendar.getInstance(), 8, 8000, 800, 80, 8, 4, true, true, false, false);
